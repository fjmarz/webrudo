    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white flex">
      ...
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-[#8A2BE2]/10 to-[#4169E1]/10 border-l border-white/10">
        <div className="w-full max-w-lg mx-auto flex flex-col justify-center p-12">
          <h2 className="text-2xl font-bold mb-8">{t('athlete-feature-title')}</h2>
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold mb-1">{t('personalized-workouts')}</h3>
                <p className="text-gray-400">
                  {t('personalized-workouts-desc')}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold mb-1">{t('real-time-tracking')}</h3>
                <p className="text-gray-400">
                  {t('real-time-tracking-desc')}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold mb-1">{t('performance-analysis')}</h3>
                <p className="text-gray-400">
                  {t('performance-analysis-desc')}
                </p>
              </div>
            </div>
          </div>
